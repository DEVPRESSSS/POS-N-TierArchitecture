...
$(document).ready(function () {
    ...
    tableData = $('#tbdata').DataTable({
        "processing": true,
        "ajax": {
            "url": "/Admin/Reports/ReportSale?startDate=01/01/1991&endDate=01/01/1991",
            "type": "GET",
            "datatype": "json"
        },
        "columns": [
...
$("#btnSearch").click(function () {
    ...
    var new_url = `/Admin/Reports/ReportSale?startDate=${$("#txtStartDate").val().trim()}&endDate=${$("#txtEndDate").val().trim()}`
